...
//             <PlusIcon className='size-4 transition-all duration-300 p-2.5 bg-gradient-to-br from-indigo-500 text-white rounded-full' />
...
//           <button className='w-full bg-white sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 text-slate-600 border border-dashed border-slate-300 group hover:border-indigo-500 hover:shadow-lg transition-all duration-300 cursor-pointer'>
//             <UploadCloudIcon className='size-4 transition-all duration-300 p-2.5 bg-gradient-to-br from-indigo-500 text-white rounded-full' />
//             <p className='text-sm group-hover:text-indigo-600 transition-all duration-300'>
...
//                 Updated on{new Date (resume.updateAt).ToLocaleDateString()}</p>
              
//               <div className='absolute top-1 right-1 group-hover:flex items-center hidden'> 
//                 <TrashIcon className="size-7 px-1.5 hover:bg-white/50 rounded text-slate-700 transition-colors " />
//                 <PencilIcon className="size-7 px-1.5 hover:bg-white/50 rounded text-slate-700 transition-colors"/>
            ...
            return (
              ...
              >
                ...
                <div onClick={e => e.stopPropagation()} className='absolute top-1 right-1 group-hover:flex items-center hidden'>
                  <TrashIcon onClick={()=> deleteResume(resume._id)} className="size-7 px-1.5 hover:bg-white/50 rounded text-slate-700 transition-colors" />
                  <PencilIcon onClick={()=> {setEditResumeId (resume._id); setTitle (resume.title)}}
                  className="size-7 px-1.5 hover:bg-white/50 rounded text-slate-700 transition-colors"/>
                </div>
              </button>
            )
          })}
